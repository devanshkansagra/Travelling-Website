...
function Bus(props) {
    return (
        <>
            <div className=' py-10 md:py-28 dev-bus-form-container'>
                <h1 className="text-center text-xl font-bold my-2 md:text-white md:text-3xl">Bus Booking</h1>
                            ...
                            <div className="flex justify-start mt-3 flex-wrap md:flex-nowrap items-center">
                                <div className="mx-2">
                                    <select name="adult" className='px-2 py-2 border rounded-lg bg-white' id="passenger">
                                        <option defaultValue={props.seatVal}>--Seats</option>
                                ...
                                <div className="mx-2 mt-3">
                                    <button className="btn bg-blue-600 text-white px-2 py-2 rounded-lg">Search for Buses</button>
                                </div>
                            </div>
                        </form>
                    </div>
